...
class WebManageDevicesScreen extends StatefulWidget {
  const WebManageDevicesScreen({super.key});

  @override
  State<WebManageDevicesScreen> createState() => _WebManageDevicesScreenState();
}

class _WebManageDevicesScreenState extends State<WebManageDevicesScreen> {
